...
class Options(object):
    def __init__(self):
        self.root_path = '/home/lizl/snap/Compression/0FSGanCompression/trained_model'
...
#------------------------------------model_train_relate------------------------------------
        ...
        self.parser.add_argument('--student_global_G_ngf', type=int, default=16,
...
#------------------------------------train_relate------------------------------------
        ...
        self.parser.add_argument('--test_epoch', type=int, default=1,
                                 help='test model from this step')
...
#------------------------------------Lr_decay_realte------------------------------------
        ...
        self.parser.add_argument('--num_epoch_decay', type=int, default=80,
