...
class Options(object):
    def __init__(self):
        self.root_path = '/home/lizl/snap/third-stage/SuperBN/trained_model'
...
#------------------------------------resume_relate------------------------------------
        ...
        self.parser.add_argument('--Super_student', type=int, default=60,
                                 help='test model from this step')
        self.parser.add_argument('--Super_teacher', type=int, default=100,
                                 help='test model from this step')
        self.parser.add_argument('--Super_discri', type=int, default=60,
                                 help='test model from this step')
...
#------------------------------------Lr_decay_realte------------------------------------
        ...
        self.parser.add_argument('--num_epoch_decay', type=int, default=200,
...
#------------------------------------Super_train_relater------------------------------------
        self.parser.add_argument('--mapping_layers', type=list, default=['con3', 'decon6'],
                                 help='target of distill map layers')
        self.parser.add_argument('--n_channels', type=dict, default={'con1':[8, 4], 'con2':[8, 4], 'con3':[8, 4], 
            'con4':[8, 4],'con5':[8, 4],
            ...
            'decon8':[[8, 4], [8, 4]]}, help='the Super net')
