...
from Teacher_Generator import Teacher_G as Decoder
# import argparse
...
def test(name, ngf, gpu_id, device=torch.device('cuda' if torch.cuda.is_available() else 'cpu')):
    ...
    model_save_dir = '/home/lizl/snap/third-stage/' + name + '/result_train/models'
    print_log = open(os.path.join('/home/lizl/snap/third-stage/all-evaluate/Original', name + 'getbest.txt'), 'w')
    print(print_log)
